...
<div class="theory-section">
    ...
    <div class="graph-metrics">
        ...
        <ul>
            <li><strong>Пропускная способность:</strong> (бит/с).</li>
...
<div class="theory-section">
    <img src="/static/images/dijkstra_example_graph.png" alt="Граф сети для примера маршрутизации">
    <p>Рисунок 1. Ориентированный взвешенный граф сети (вес ∞ означает недоступный канал)</p>
</div>

<!-- Блок 6 — Переход к практике и кнопка наверх -->
<div class="btn-practice-wrap">
    <a href="/dijkstra/practice" class="btn-practice">Перейти к практике →</a>
    <a href="javascript:void(0);" class="btn-practice" onclick="window.scrollTo({top:0,behavior:'smooth'});" style="margin-left: 15px;">↑ Наверх</a>
</div>